...
CoolClock.config = {
	...
	skins:	{
		...
		newClock2: {
			outerBorder: { lineWidth: 4, radius:97, color: "deepPink", alpha: 1 },
		hourHand:         { lineWidth: 80, startAt: -15, endAt: 35,  color: 'black', alpha: 0.2 },
		largeIndicator: { lineWidth: 8, startAt: 80, endAt: 93, color: "yellow", alpha: 0.3 },
		minuteHand:       { lineWidth: 80, startAt: -15, endAt: 65,  color: 'greenYellow', alpha: 0.5 },
		secondDecoration: { lineWidth: 1,  startAt: 40,  radius: 40, color: "#fff", fillColor: 'yellow', alpha: 0.5 }
		},

		newClock3: {
		
		hourHand:         { lineWidth: 80, startAt: -15, endAt: 35,  color: 'magenta', alpha: 0.2 },
		largeIndicator: { lineWidth: 8, startAt: 80, endAt: 93, color: "SteelBlue", alpha: 0.3 },
		...
		newClock: {
			outerBorder: { lineWidth: 4, radius:97, color: "cyan", alpha: 1 },
		hourHand:         { lineWidth: 80, startAt: -15, endAt: 35,  color: 'magenta', alpha: 0.2 },
		largeIndicator: { lineWidth: 8, startAt: 80, endAt: 93, color: "SteelBlue", alpha: 0.3 },
		minuteHand:       { lineWidth: 80, startAt: -15, endAt: 65,  color: 'cyan', alpha: 0.5 },
		secondDecoration: { lineWidth: 1,  startAt: 40,  radius: 40, color: "#fff", fillColor: 'yellow', alpha: 0.5 }
    ...
    avantiClock: {
			...
			smallIndicator: { lineWidth: 4, startAt: 89, endAt: 93, color: "teal", alpha: 1 },
			largeIndicator: { lineWidth: 8, startAt: 80, endAt: 93, color: "SteelBlue", alpha: 1 },
			hourHand: { lineWidth: 12, startAt: -15, endAt: 60, color: "MediumTurquoise", alpha: 1 },
			minuteHand: { lineWidth: 10, startAt: -15, endAt: 85, color: "dodgerblue", alpha: 1 },
			secondHand: { lineWidth: 4, startAt: -20, endAt: 85, color: "orange", alpha: 1 },
			secondDecoration: { lineWidth: 2, startAt: 70, radius: 8, fillColor: "white", color: "white", alpha: 1 }
		},
		swissRail: {
